...
WORKDIR /src
COPY ["Momentum.Rabbits.Api.csproj", "Momentum.Rabbits.Api/"]
RUN dotnet restore "Momentum.Rabbits.Api/Momentum.Rabbits.Api.csproj"

WORKDIR "/src/Momentum.Rabbits.Api"
COPY . .
RUN dotnet build "Momentum.Rabbits.Api.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "Momentum.Rabbits.Api.csproj" \
...
Execute unit tests
```
    cd "Momentum.Rabbits.Api/test/Momentum.Rabbits.Api.Tests"
    dotnet test
```

Deploy application
```
    cd "Momentum.Rabbits.Api/src/Momentum.Rabbits.Api"
